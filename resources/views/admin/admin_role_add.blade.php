	...
	<form class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="name" name="name" datatype="*4-16">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<dl class="permission-list">
					<dt>
						<label>
							<input type="checkbox" name="power_ids[]" value="{{$power['id']}}" id="user-Character-0">
							{{$power['name']}}
						</label>
					</dt>
					<dd>
						...
						<dl class="cl permission-list2">
							<dt>
								<label class="">
									<input type="checkbox" value="{{$val['id']}}" name="power_ids[]" id="user-Character-0-0">
									{{$val['name']}}</label>
							</dt>
							<dd>
								@foreach ($val['res'] as $v)
								<label class="">
									<input type="checkbox" value="{{$v['id']}}" name="power_ids[]" id="user-Character-0-0-0">
									{{$v['name']}}
								</label>
								@endforeach
							</dd>
