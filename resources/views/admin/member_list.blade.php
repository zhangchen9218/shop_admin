		...
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
					...
					<a href="javascript:;" onclick="member_add('添加用户','{{url('admin/user/create')}}','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a>
				</span>
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					@foreach($users as $user)
						<tr class="text-c">
							<td><input type="checkbox" value="1" name="del"></td>
							<td>{{$user->id}}</td>
