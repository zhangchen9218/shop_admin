		...
		<form class="form form-horizontal" id="form-permission-add" enctype="multipart/form-data">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-7 col-sm-8 skin-minimal">
                    <div class="check-box">
                        <input type="checkbox" id="acme" name="acme" value="1">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-7 col-sm-8">
                    <div class="select-box">
                        <select name="belong_to" id="belong_to" class="select">
                            @foreach ($acmeRes as $acme)
                                <option value="{{$acme->id}}">{{$acme->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-7 col-sm-8">
                    <textarea id="field" name="field" class="textarea radius"></textarea>
                </div>
                <div class="col-3"> </div>
            </div>
			<div class="row cl">
