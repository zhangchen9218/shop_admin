...
<article class="page-container">
	<div class="pd-20">
		...
		@endif
		<form action="{{url("admin/column/$column->id")}}" method="post" class="form form-horizontal" id="form-column-update" enctype="multipart/form-data">
			...
			<div id="tab-category" class="HuiTab">
				...
				<div class="tabCon">
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">{{$column->id}}</div>
					</div>
					<div class="row cl">
						...
						<input type="hidden"	id="level" name="level" value="{{$column->level}}">
						<div class="col-3"> </div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>栏目名称：</label>
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="{{$column->name}}" placeholder="" id="name" name="name">
						</div>
						<div class="col-3"> </div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
							<select name="cotegory_id" id="cotegory_id" class="select">
								@foreach (COLUMN_CATEGORY as $val)
									<option value="{{$val['id']}}" @if ($column->cotegory_id == $val['id']) selected @endif>{{$val['name']}}</option>
								@endforeach
							</select>
							</span> </div>
						<div class="col-3"> </div>
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9 skin-minimal">
							<div class="check-box">
								<input type="checkbox" id="selectable" @if ($column->selectable) checked="checked" @endif  name="selectable" value="1">
				...
				<div class="tabCon">
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<span class="btn-upload form-group">
							  <input class="input-text upload-url radius" type="text"  placeholder="如果不选则不改变模板" readonly><a href="javascript:void();" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe642;</i> 浏览文件</a>
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="@if( isset($column->template()->first()->limit )){{$column->template()->first()->limit}} @endif" name="limit" style="width:200px;">
						</div>
						<div class="col-3"> </div>
					</div>
				</div>
				<div class="tabCon">
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="@if( isset($column->seo->keyword)){{$column->seo->keyword}} @endif" name="keyword" id="keyword">
						</div>
						<div class="col-3"> </div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<textarea id="describe" name="describe" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符">@if( isset($column->seo->describe)){{$column->seo->describe}} @endif</textarea>
						</div>
						<div class="col-3"> </div>
					</div>
				</div>
